...
class LLMJsonOutputParser(BaseModel):
    ...
    def parse_and_validate(
        cls, json_str: str, json_schema: str
        ...
        # Parse JSON
        try:
            json_str = cls._parse_json(json_str, json_schema)
        except ParseJsonException as e:
            raise ParseJsonException(str(e))

        # Validate JSON
        try:
            return cls._validate_json(json_str, json_schema)
    ...
    @classmethod
    def _parse_json(cls, json_str: str, json_schema: str) -> Union[str, Dict[Any, Any]]:
        """
        ...
        try:
            ai_fixed_json = cls._fix_json(json_str, json_schema)
    ...
    @classmethod
    def _validate_json(
        cls, json_obj: Union[str, Dict[Any, Any]], json_schema: str
    ) -> Union[str, Dict[Any, Any]]:
        """
        ...
        try:
            ...
            # Now try to fix this up using the ai_functions
            try:
                ai_fixed_json = cls._fix_json(json.dumps(json_obj), json_schema)
                return json.loads(ai_fixed_json)
            except FixJsonException as e:
                raise ValidateJsonException("Could not validate JSON:" + str(e))

    @staticmethod
    def _fix_json(json_str: str, schema: str) -> str:
        """
